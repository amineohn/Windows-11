    ...
    return (
        <>
            <div className="flex flex-col justify-between fade-in">
                <main className="flex justify-center min-h-screen items-center w-full h-full">
                    ...
                    <Transition
                        ...
                        <>
                            ...
                            <div className="w-[642px] h-[726px] bg-neutral-900 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
                                    ...
                                    <div className="space-y-8">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full h-10 px-12 py-4 rounded-[0.250rem] text-light bg-neutral-900 text-gray-300 placeholder-gray-300 border-b-[3px] border-r-2 border-r-neutral-800 border-l-2 border-l-neutral-800 border-t-2 border-t-neutral-800 border-b-blue-700 focus:outline-none focus:shadow-outline"
                                            />
                                        </div>
                ...
                <div className="bg-neutral-900/80 backdrop-filter backdrop-blur-lg py-1 sticky bottom-0">
