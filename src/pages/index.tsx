            ...
            <div className="flex flex-col justify-between">
                ...
                <div className="absolute px-2 py-2">
                    <div className="flex justify-center items-center flex-col hover:bg-white/10 rounded-lg transition-colors py-4 px-4 cursor-pointer">
                        <img className="w-12 h-12 rounded-lg" src="https://media.contentapi.ea.com/content/dam/gin/images/2019/08/nsfh-keyart-gin.jpg.adapt.crop1x1.767p.jpg" />

                        <span className="text-white/90 text-md font-medium">Tuner mode</span>
                    </div>
                    <div className="flex justify-center items-center flex-col hover:bg-white/10 rounded-lg transition-colors py-4 px-4 cursor-pointer">
                        <svg className="w-12 h-12" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2931 2931" width="2931" height="2931">
                            <path
                                className="st0"
