                                        ...
                                        <div className="w-[576px] h-[302px]">
                                            ...
                                            <div className="flex justify-center items-center mt-10">
                                                <div className="flex items-center justify-center">
                                                    <div className="w-[96px] h-[84px] hover:bg-black/20 transition-colors ease-in-out duration-150 rounded-md">
                                                ...
                                                <div className="top-0 -ml-10">
                                                    <div className="w-[642px] h-[62px] border-b-transparent border border-l-transparent border-r-transparent border-t-neutral-800/70 rounded-b-lg">
                                                        <div className="flex justify-evenly	space-x-60 mt-2">
                                                            <div className="w-[163px] h-[48px] inline-flex space-x-2 justify-center items-center mt-1 hover:bg-black/20 transition-colors ease-in-out duration-150 rounded-md">
                                                            ...
                                                            <div className="flex justify-center items-center">
                                                                <div className="w-10 h-10 flex justify-center items-center hover:bg-black/20 transition-colors ease-in-out duration-150 rounded-md">
                ...
                <div className="bg-neutral-900/80 backdrop-blur-lg py-1 sticky bottom-0">
                    <div className="flex justify-between items-center space-x-3">
                        ...
                        <div className="flex items-center justify-end px-2">
                            <div className="flex justify-end items-center w-20 h-10 px-2 hover:bg-black/20 transition-colors ease-in-out duration-150 rounded-md">
                            ...
                            <div className="flex flex-col hover:bg-black/20 transition-colors ease-in-out duration-150 rounded-md px-1.5 py-1.5">
