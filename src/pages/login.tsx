                    ...
                    <div className="">
                        <div className="space-y-5">
                            <div className="flex justify-center items-center">
                                <img src="/static/images/user.png" className="w-48 h-48 rounded-full shadow-2xl" alt="me" />
                            </div>
                            <form method="POST" onSubmit={handleSubmit}>
                                <input
                                    type="password"
                                    onChange={(e) => setPassword(e.target.value)}
                                    className={`w-80 h-12 px-4 py-4 rounded-lg bg-white/70 dark:bg-neutral-800/70 dark:hover:bg-neutral-800/80 hover:bg-white/80 transition text-gray-900 dark:text-gray-100 placeholder-gray-800 dark:placeholder-gray-100 shadow-2xl ${
