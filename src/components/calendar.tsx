...
const Calendar = ({ open }) => {
    return (
        <Transition
            ...
            className="calendar flex flex-col bg-neutral-700/40 backdrop-blur-lg rounded-md shadow-2xl duration-200 overflow-hidden">
            <div className="flex items-center bg-black/10 px-6 py-4">
                <span className="text-sm text-gray-700 dark:text-white flex-grow">Tuesday, February 15</span>
                <button className="bg-gray-400 bg-opacity-10 border border-gray-400 border-opacity-20 p-1.5 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="transform rotate-180 fill-current w-[10px] h-[10px] text-gray-700 dark:text-gray-200">
            ...
            <div className="flex justify-center items-center gap-3 px-6 pt-4">
                ...
                <button className="flex justify-center items-center hover:bg-gray-600 hover:bg-opacity-10 dark:hover:bg-white dark:hover:bg-opacity-10 rounded-md duration-150">
                    <svg width="24" height="24" viewBox="0 0 27 23" xmlns="http://www.w3.org/2000/svg" className="fill-current text-gray-600 dark:text-gray-400 p-2 transform rotate-180">
                        <path d="M11.7679 0.999999C12.5378 -0.333335 14.4623 -0.333333 15.2321 1L26.0574 19.75C26.8272 21.0833 25.8649 22.75 24.3253 22.75H2.67468C1.13508 22.75 0.172831 21.0833 0.942632 19.75L11.7679 0.999999Z"></path>
                    </svg>
                </button>
            </div>
